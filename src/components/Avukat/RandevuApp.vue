<template>
  <div class="bg-black">
    ...
    <section class="text-gray-600 body-font CostumContainer relative bg-black">
      ...
      <div
        v-if="errorMessage"
        class="absolute left-5 top-5 z-30 animate-fadeInSlide p-2"
      >
        <AlertError
          name="Hata"
          message="Size ulaşabilmemiz için lütfen bilgileri eksiksiz doldurun."
          class="!bg-gray-950/70"
        >
          <template #icon>
      ...
      >
        <iframe
          ...
          class="w-full mx-auto h-[47rem] mb-20 animate-fadeInSlide"
        ></iframe>
        <form
        ...
        >
          <div
            class="loginBg rounded-lg p-8 flex flex-col z-10 shadow-md slideInUp"
          >
