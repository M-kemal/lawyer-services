<template>
  <div>
    <section class="destination">
      <h1>{{ destination.name }} - PD</h1>
      <div class="destination-details">
        <img :src="destination.img" :alt="destination.name" class="w-96" />
        <p>{{ destination.job }}</p>
      </div>
    </section>
    <section class="experiences">
      ...
      <div class="cards">
        ...
        >
          <AvukatCard :experience="experience" />
        </router-link>
      </div>
      <router-view />
    </section>
...
import AvukatCard from "./AvukatCard.vue";
export default {
  setup() {
