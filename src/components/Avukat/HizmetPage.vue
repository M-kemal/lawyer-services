<template>
  <div
    class="bg-black h-full text-white w-full selection:bg-firstColor selection:text-black"
  >
    <HeaderApp />
    <div class="CostumContainer bg-black">
      ...
      <div class="my-20 grid h4:grid-cols-1 h8:grid-cols-2 k1:grid-cols-3">
        <div
          class="hizmetler"
          v-for="hizmetler in avukatHizmet"
          :key="hizmetler.id"
        >
